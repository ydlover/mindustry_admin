...
STRINGS.CONFIRM_DELETE_BOOK = '是否删除？';
STRINGS.DOWNLOAD_FILE = '下载文件';
STRINGS.DELETE_FILE = '删除文件';
STRINGS.USE_ONE_BROWSER = '无法上传文件，请勿使用多个浏览器窗口同时上传。';
STRINGS.UPLOAD_FAILED = '上传失败。';
STRINGS.UNSUPPORTED_FILE_TYPE = '请选择mmap格式的文件。';
...
STRINGS.SUPPORTED_FILE_TYPES = '支持mmap';
STRINGS.CANNOT_CONNECT_SERVER = '无法连接服务器。';
...
STRINGS.EXCEEDS_FILE_SIZE =  '无法上传文件，请勿上传大于1024KB的文件。';
STRINGS.UNSUPPORTED_BROWSER_TYPE = '请使用Chrome、Firefox或Safari浏览器。';
